...
def main():
    ...
    try:
        ...
        input("Press Enter to speak the first sentence on Connection A...")
        tts.speak("Hello")
        tts.speak("Hellod from connection A. I will talk for about two seconds.")
        input(">") 
        
        print("Now interrupting and speaking with Connection B.")
